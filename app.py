...
def generate_qrcode():
    ...
    # Configurar e gerar QR code com maior capacidade e correção de erros
    qr = qrcode.QRCode(
        version=None,  # Determina automaticamente o melhor tamanho
        error_correction=qrcode.constants.ERROR_CORRECT_Q,  # Maior correção de erros
        box_size=10,
        border=4,
    )
    qr.add_data(data)
